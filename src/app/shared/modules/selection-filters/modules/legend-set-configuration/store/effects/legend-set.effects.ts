...
import { LegendSetService } from '../../services/index';
import { LegendSetState } from '../reducers/legend-set.reducer';
import { getAllLegendSets } from '../selectors/legend-set.selectors';
...
export class LegendSetEffects {
  constructor(
    ...
    private store$: Store<LegendSetState>
  ) {}
